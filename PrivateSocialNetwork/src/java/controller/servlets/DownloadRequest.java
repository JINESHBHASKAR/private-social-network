 ...
 * @author Jinesh
 */
@WebServlet(name = "DownloadRequest", urlPatterns = {"/DownloadRequest"})
public class DownloadRequest extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            String sql = "INSERT INTO notifications(recipient_id,sender_id,type) values (?,?,'request')";
            ...
            if(res>0) {
                    ...
                    jsonData.put("message", "Request Coompleted");
            } else {
                    jsonData.put("status", "fail");
                    jsonData.put("message", "Unable to request");
            }
